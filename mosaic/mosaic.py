...
import time
import random
from mosaic import edges, guides, tiles, convex, coloring, plotting

def create_roman_mosaic(fname, output_path):
    ...
    if 'final_recolored' in plot_list:
        ...
        for key in keys:
            ...
            plotting.draw_tiles(polygons_post, new_colors, h, w, background_brightness=0.2,
                                return_svg=None, chains=None, title=title, output_path=output_path)
...
if __name__ == '__main__':
    create_roman_mosaic('01.jpg', 'output.jpg')